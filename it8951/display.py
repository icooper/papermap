#
# Originally from GregDMeyer's IT8951 driver: https://github.com/GregDMeyer/IT8951
#
...
class AutoDisplay:
    ...
    def draw_partial(self, mode):
        ...
        if diff_box is not None:
            ...
            if mode in { DisplayModes.DU, DisplayModes.A2 }:
    ...
    @staticmethod
    def _round_bbox(box, width, height, round_to=4):
        '''
        ...
        return (minx, miny, min(maxx, width), min(maxy, height))
